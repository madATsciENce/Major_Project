...
// Fetch user by email and phone number and check verified status
$aa="Select * from registration_signup where Email= '$b' and Phone_Number = '$c' and verified = 1";
...
if($count>0)
{
    ...
    if (password_verify($f, $cc['Password'])) {
?>
...
{
echo "Invalid login credentials or phone number does not match.";
//include("sign.php");
}
}
?>
