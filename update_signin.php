    ...
    ?>
        <form name="f" action="update.php" method="post">
            <tr>
                ...
                Phone number:<td><input type="text" name="Phone_Number" size="10"
                        value="<?php echo $dd["Phone_Number"]; ?>"></td><br><br>
                Age:<td><input type="text" name="Age" size="10" value="<?php echo $dd["Age"]; ?>"></td><br><br>
                Gender:<td><input type="text" name="Select_Gender" size="10" value="<?php echo $dd["Select_Gender"]; ?>">
                </td><br><br>
                Password:<td><input type="text" name="Password" size="10" value="<?php echo $dd["Password"]; ?>"></td>
                <br><br>
                Confirm_Password:<td><input type="text" name="Confirm_Password" size="10"
                        value="<?php echo $dd["Confirm_Password"]; ?>"></td><br><br>
